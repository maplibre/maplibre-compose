...
public class MapCanvas(
  ...
  override fun paintGL() {
    ...
    val w = this.width * transform.scaleX
    val h = this.height * transform.scaleY
  ...
  //    if (this.isValid) renderer?.render()
  //  }
  //
  ...
  //
  //  /**
  //   * Handles resizing of the MapCanvas. When the component is resized, it updates the size of
  // the
