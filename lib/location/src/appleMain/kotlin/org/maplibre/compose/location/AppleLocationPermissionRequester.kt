 ...
 *
 * [AppleLocationProvider] delegates [LocationProvider.permission] and
  ...
  private val delegate =
    object : NSObject(), CLLocationManagerDelegateProtocol {
      override fun locationManagerDidChangeAuthorization(manager: CLLocationManager) {
        if (manager != this@AppleLocationPermissionRequester.manager) return
...
private fun readAppleLocationPermission(manager: CLLocationManager): LocationPermission =
