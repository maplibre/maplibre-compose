...
class MlnFfiStyleOwnershipTest {
  ...
  @Test
  fun a_layer_rejects_a_source_descriptor_owned_by_another_map() {
    BridgeMapFixture.create().use { first ->
      BridgeMapFixture.create().use { second ->
        first.loadStyle(BaseStyle.Empty)
        second.loadStyle(BaseStyle.Empty)
  ...
  @Test
  fun different_live_source_descriptors_cannot_share_an_id() {
    BridgeMapFixture.create().use { fixture ->
      fixture.loadStyle(BaseStyle.Empty)
      ...
      assertNull(second.binding.takeIf { it.isLoaded })
    }
  }

  @Test
  fun a_failed_layer_attachment_can_be_retried() {
    BridgeMapFixture.create().use { fixture ->
      fixture.loadStyle(BaseStyle.Empty)
      val style = requireNotNull(fixture.style)
  ...
  @Test
  fun layer_before_source_attachment_is_idempotent_for_the_same_descriptor() {
    BridgeMapFixture.create().use { fixture ->
      fixture.loadStyle(BaseStyle.Empty)
      val style = requireNotNull(fixture.style)
