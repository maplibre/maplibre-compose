...
internal class InteractionSubscriptions(initial: MapInteractions) {
  ...
  val contextClick = SubscriptionSlot()
  val twoFingerClick = SubscriptionSlot()
  ...
  fun update(options: MapInteractions) {
    ...
    contextClick.update(options.callbacks.contextClick != null)
    twoFingerClick.update(options.callbacks.twoFingerClick != null)
