...
internal fun CameraInputTarget.inputScaleBy(
  scale: Double,
  anchor: DpOffset?,
  gestureToken: CameraInputToken?,
) {
...
internal fun CameraInputTarget.inputRotateAndPitchBy(
  bearingDelta: Double,
  pitchDelta: Double,
...
internal suspend fun CameraInputTarget.inputPanByAwaitingTransition(
  deltaX: Double,
  deltaY: Double,
  duration: Duration,
  gestureToken: CameraInputToken,
...
internal suspend fun CameraInputTarget.inputScaleByAwaitingTransition(
  scale: Double,
  anchor: DpOffset?,
  duration: Duration,
  gestureToken: CameraInputToken,
...
internal suspend fun CameraInputTarget.inputRotateAndPitchByAwaitingTransition(
  bearingDelta: Double,
  pitchDelta: Double,
  duration: Duration,
  gestureToken: CameraInputToken,
...
internal suspend fun CameraInputTarget.inputFitBoundsAwaitingTransition(
  fit: BoxZoomFit,
  duration: Duration,
  gestureToken: CameraInputToken,
) {
