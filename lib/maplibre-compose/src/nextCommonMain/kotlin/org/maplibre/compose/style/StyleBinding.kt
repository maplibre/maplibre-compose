...
internal interface StyleBinding {
   ...
   * the caller rather than inside the queued add.
   *
   * @return null if the style has unloaded or the answer could not be determined; the queued add
   *   still refuses a duplicate in that case.
   */
