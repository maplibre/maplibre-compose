...
internal class DesktopMapSession(
  ...
  override fun setGestureSettings(value: GestureOptions) {
    // Gestures are implemented in Compose, so these options are read by DesktopMapView's input
  ...
  /**
   * Reports a secondary click at [offset] as a long click: desktop has no press-and-hold
