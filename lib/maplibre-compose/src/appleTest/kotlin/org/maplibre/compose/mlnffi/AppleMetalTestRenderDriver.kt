 ...
 */
internal class AppleMetalTestRenderDriver
private constructor(private val device: MTLDeviceProtocol) : FfiTestRenderDriver {
  ...
  companion object {
    ...
    fun create(): AppleMetalTestRenderDriver {
      ...
      return AppleMetalTestRenderDriver(device)
    }
