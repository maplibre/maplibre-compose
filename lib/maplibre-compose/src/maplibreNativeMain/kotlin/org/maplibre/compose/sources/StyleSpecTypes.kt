...
/**
 * The style spec name, or null for custom-vector or unknown source types. [SourceType.toString]
 * returns the generated FFI representation, such as `SourceType(nativeValue=1)`, instead of the
 * style spec name.
 */
