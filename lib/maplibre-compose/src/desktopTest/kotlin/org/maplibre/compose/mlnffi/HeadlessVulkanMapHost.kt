...
/**
 * A [MlnFfiMapHost] that renders on a real GPU with no window: a genuine Vulkan device and
 ...
 */
internal class HeadlessVulkanMapHost private constructor() : MlnFfiMapHost {
  ...
  ): MlnFfiMapFrame = rendererThread.run {
  ...
  companion object {
    ...
    private val PROBE_EXTENT =
      MlnFfiMapExtent.fromLogical(width = 16, height = 16, scaleFactor = 1.0)
  }
}
...
private constructor(
  ...
  companion object {
    fun create(context: HeadlessVulkanContext, extent: MlnFfiMapExtent): HeadlessVulkanTexture {
