...
class ComputedSourceTest {
  ...
  @Test
  fun `a computed source renders features a query can hit`() {
    val fixture = HeadlessMapFixture.create()
    fixture.use {
      val source = it.attachComputedSource()

      it.pumpUntil("the computed source's features to be queryable") {
        it.queryCenter().isNotEmpty()
      }
  ...
  @Test
  fun `invalidating a tile asks for its features again`() {
    val fixture = HeadlessMapFixture.create()
    fixture.use {
      val source = it.attachComputedSource()
      it.pumpUntil("the computed source's features to be queryable") {
  ...
  @Test
  fun `invalidating a region asks for its features again`() {
    val fixture = HeadlessMapFixture.create()
    fixture.use {
      val source = it.attachComputedSource()
      it.pumpUntil("the computed source's features to be queryable") {
  ...
  @Test
  fun `setData replaces what a tile was computed with`() {
    val fixture = HeadlessMapFixture.create()
    fixture.use {
      val source = it.attachComputedSource()
      it.pumpUntil("the computed source's features to be queryable") {
