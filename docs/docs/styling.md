...
```kotlin
-8<- "demo-app/common/src/commonMain/kotlin/org/maplibre/compose/docsnippets/Styling.kt:simple"
```
...
```kotlin
-8<- "demo-app/common/src/commonMain/kotlin/org/maplibre/compose/docsnippets/Styling.kt:dynamic"
```
...
```kotlin
-8<- "demo-app/common/src/commonMain/kotlin/org/maplibre/compose/docsnippets/Styling.kt:local"
```
