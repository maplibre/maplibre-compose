...
```kotlin title="App.kt"
-8<- "demo-app/common/src/commonMain/kotlin/org/maplibre/compose/docsnippets/Material3.kt:controls"
```
...
```kotlin title="App.kt"
-8<- "demo-app/common/src/commonMain/kotlin/org/maplibre/compose/docsnippets/Material3.kt:disappearing-controls"
```
