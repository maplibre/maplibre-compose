...
-8<- "demo-app/common/src/androidMain/kotlin/org/maplibre/compose/docsnippets/Interaction.kt:common-gesture-ornament"
```
...
-8<- "demo-app/common/src/androidMain/kotlin/org/maplibre/compose/docsnippets/Interaction.kt:gesture-settings"
```
...
```kotlin title="map.android.kt"
-8<- "demo-app/common/src/androidMain/kotlin/org/maplibre/compose/docsnippets/Interaction.kt:ornament-settings"
```
...
```kotlin
-8<- "demo-app/common/src/androidMain/kotlin/org/maplibre/compose/docsnippets/Interaction.kt:camera"
```
...
```kotlin
-8<- "demo-app/common/src/androidMain/kotlin/org/maplibre/compose/docsnippets/Interaction.kt:camera-animate"
```
...
```kotlin
-8<- "demo-app/common/src/androidMain/kotlin/org/maplibre/compose/docsnippets/Interaction.kt:click-listeners"
```
