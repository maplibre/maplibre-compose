...
Package one runtime artifact for each target application. Vulkan remains the
default Windows choice; select the OpenGL artifact when MapLibre should render
through the WGL-to-Direct3D 12 bridge.
