...
<Code code={region(controls, "default")} lang="kotlin" />
...
<Code code={region(controls, "disabled")} lang="kotlin" />
...
<Code code={region(controls, "custom")} lang="kotlin" />
...
<Code code={region(material3, "overlay")} lang="kotlin" />

Each Material 3 control is also a composable you can place in a `MapOverlay`
of your own:

<Code code={region(material3, "controls")} lang="kotlin" />
...
<Code code={region(controls, "insets")} lang="kotlin" />
...
<Code code={region(controls, "placedAt")} lang="kotlin" />
...
<Code code={region(controls, "placedTowards")} lang="kotlin" />
