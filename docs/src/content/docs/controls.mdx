...
a location is out of view. It places the child along an ellipse inside the
unobstructed map region and hides it while the location is inside that ellipse.
