...
child appears only while the position is outside of the ellipse, so it marks a
target that scrolled out of view.
...
[Material 3 extensions](/maplibre-compose/material3/) is a styled consumer of
