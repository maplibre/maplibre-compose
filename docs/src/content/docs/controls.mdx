...
which ones. The default is the MapLibre logo and an attribution button along the
bottom edge.
...
The [Material 3 extensions](/maplibre-compose/material3/) add themed versions of
these controls, plus a compass.
