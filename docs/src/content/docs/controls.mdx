...
Use <Api of="MapOverlayScope.placedTowards" /> for a direction indicator when
...
The placement modifiers fill the available space. Put marker sizing, padding,
and drawing modifiers after `placedAt` or `placedTowards`. Put sizing or padding
before them to change the placement region instead.
...
<Api of="PointerPinButton" /> from the Material 3 module uses this modifier
