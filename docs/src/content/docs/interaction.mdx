...
description: Configure gestures and ornaments, drive the camera, and listen for clicks.
---
...
<Code code={region(interaction, "common-gesture-ornament")} lang="kotlin" title="map.common.kt" />
...
<Aside>
  We provide Material 3 alternatives to the default ornaments. See the
  [Material 3 extensions section](/maplibre-compose/material3/) for more
  information.
</Aside>
...
<Code code={region(interaction, "ornament-settings")} lang="kotlin" title="map.android.kt" />
